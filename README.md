...
- registers a `ResourceFormatSaver` with authored-scene, composed-stage, static-source-preserving, static transform/skeleton/animation edit merge, composition-preserving, and source-preserving variant save paths
...
The current regression manifest runs 44 isolated scripts and passes locally with the debug macOS arm64 build.
